...
const TagManager = require('../manager/TagManager');
...
module.exports = {
    ...
    create: function (req, res) {
        ...
        TagManager.create(accessUserId, accessUserType, value, function (errorCode, errorMessage, httpCode, errorDescription, tag) {
            if (errorCode) {
    ...
    getOne: function (req, res) {
        ...
        TagManager.getOne(accessUserId, accessUserType, id, function (errorCode, errorMessage, httpCode, errorDescription, results) {
            if (errorCode) {
                return Rest.sendError(res, errorCode, errorMessage, httpCode, errorDescription);
            } else {
                return Rest.sendSuccessOne(res, results, httpCode);
